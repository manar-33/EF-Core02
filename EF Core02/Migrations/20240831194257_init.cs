    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Stud_Course", x => new { x.Course_Id, x.Student_Id });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Stud_CourseCourse_Id = table.Column<int>(type: "int", nullable: true),
                    Stud_CourseStudent_Id = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        columns: x => new { x.Stud_CourseCourse_Id, x.Stud_CourseStudent_Id },
